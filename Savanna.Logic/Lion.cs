...
namespace Savanna.Logic
{
    ...
    internal class Lion : Animal
    {
        ...
        internal override int RoundsToDecompose => LION_ROUNDS_TO_DECOMPOSE;
        ...
        internal override double MaxAgeLimit => LION_MAX_AGE;
        internal override double ChildrenBearingAge => LION_CHILDREN_BEARING_AGE;
        internal override double ChildrenPauseTime => LION_CHILDREN_PAUSE_TIME;
        ...
        internal override Direction? DecideMoveDirection(AnimalCoordinates self, Animal[,] surroundings, List<AnimalCoordinates>? antelopes = null, List<AnimalCoordinates>? allies = null)
        {
        ...
        internal AnimalCoordinates GetClosestAntelope(AnimalCoordinates self, List<AnimalCoordinates> antelopes)
        {
        ...
        internal List<Direction> GetClosestDirectionsToAntelope(List<Direction> directions, AnimalCoordinates self, AnimalCoordinates antelope)
        {
        ...
        internal void Attack(Animal antelope)
        {
        ...
        internal void MoveBySmell(World world, AnimalCoordinates self)
        {
